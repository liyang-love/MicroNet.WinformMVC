...
using     MicroNet.IOC.Dependencies;
using     MicroNet.IOC.Injection;
using     MicroNet.IOC.Injection.Emit;
using     MicroNet.IOC.Injection.Func;
using     MicroNet.IOC.Injection.Instance;
using     MicroNet.IOC.Injection.Reflection;

namespace     MicroNet.IOC.Configuration.Injection
{
