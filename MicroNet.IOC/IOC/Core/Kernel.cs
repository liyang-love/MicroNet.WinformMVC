...
using     MicroNet.IOC.Extensions.OpenGeneric;
using   MicroNet.Helpers;
using     MicroNet.IOC.Injection.Emit;
using     MicroNet.IOC.Mapping;
using     MicroNet.IOC.Observers;
using     MicroNet.IOC.Registry;
using     MicroNet.IOC.Utils;

namespace     MicroNet.IOC.Core
{
    /// <summary>
    /// This is the core and facade of the <c>    MicroNet.IOC</c>, which exposes all the functionality needed 
    ...
    public sealed class Kernel
    {
        ...
        /// <summary>
        /// Gets the configuration options for the <b>    MicroNet.IOC</b>.
        /// </summary>
